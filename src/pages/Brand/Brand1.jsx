  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신확장 로제비앙 메가시티 - 브랜드 소개</title>
        <meta
          name="description"
          content="신확장 로제비앙 메가시티의 브랜드 철학과 가치를 소개합니다. 현대건설의 대표 브랜드 신확장 로제비앙 메가시티는 고급스러움과 실용성을 결합한 주거공간을 제공합니다. 고객의 삶을 중심에 둔 설계와 혁신적인 기술, 지속 가능한 개발 철학을 통해 미래를 선도하는 주거 문화를 만들어갑니다. 신확장 로제비앙 메가시티의 브랜드 스토리와 비전을 확인해보세요.
"
        />
        <meta
          name="keywords"
          ...
          {`
                                        {
                                            ...
                                            "@type": "WebPage",
                                            "name": "신확장 로제비앙 메가시티 - 브랜드 소개",
                                            "description": "신확장 로제비앙 메가시티의 브랜드 철학과 가치를 소개합니다. 현대건설의 대표 브랜드 신확장 로제비앙 메가시티는 고급스러움과 실용성을 결합한 주거공간을 제공합니다. 고객의 삶을 중심에 둔 설계와 혁신적인 기술, 지속 가능한 개발 철학을 통해 미래를 선도하는 주거 문화를 만들어갑니다. 신확장 로제비앙 메가시티의 브랜드 스토리와 비전을 확인해보세요.
",
      ...
      <p className={styles.screenReaderOnly}>
        신확장 로제비앙 메가시티의 신뢰와 품질을 최우선으로 여기는 브랜드입니다.
      ...
      >
        ...
        <div>신확장 로제비앙 메가시티, 반도체클러스터의 중심에 서다</div>
      </div>

      <img
        className={`${styles.image} ${isImageVisible ? styles.visible : ""}`}
        src={page1}
        alt="신확장 로제비앙 메가시티 brand-Image1"
      />
