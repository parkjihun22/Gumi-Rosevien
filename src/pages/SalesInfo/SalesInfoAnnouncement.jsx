  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신확장 로제비앙 메가시티 - 모집공고안내</title>
        <meta
          name="description"
          content="신확장 로제비앙 메가시티의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요."
        />
        <meta
          name="keywords"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "신확장 로제비앙 메가시티 - 모집공고안내",		"description": "신확장 로제비앙 메가시티의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요.",		"url": "https://leecols.kr/SalesInfo/announcement"	}	`}
        </script>
      </Helmet>
      ...
      <h1 className={styles.screenReaderOnly}>
        신확장 로제비앙 메가시티 - 모집공고안내
      </h1>
      <p className={styles.screenReaderOnly}>
        신확장 로제비앙 메가시티의 모집 공고는 분양 전 단계에서 중요한
