    ...
    <div className={styles.container}>
      <Helmet>
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "구미 로제비앙 메가시티 - 호수배치도", "description": "구미 로제비앙 메가시티의 단지호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다 ",		"url": "https://leecols.kr/ComplexGuide/detailintro"	}	`}
        </script>
      </Helmet>
