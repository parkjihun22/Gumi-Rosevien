  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신확장 로제비앙 메가시티 - 호수배치도</title>
        <meta
          name="description"
          content="신확장 로제비앙 메가시티의 단지호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다"
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="신확장 로제비앙 메가시티의 호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다"
        />
        <meta
          name="twitter:image"
          content="https://leecols.kr/Main1.png"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "신확장 로제비앙 메가시티 - 호수배치도", "description": "신확장 로제비앙 메가시티의 단지호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다 ",		"url": "https://leecols.kr/ComplexGuide/detailintro"	}	`}
        </script>
      </Helmet>
      ...
      <img
				...
				src={page1}
				alt="신확장 로제비앙 메가시티 호수배치도-image1"
