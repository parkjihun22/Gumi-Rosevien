  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신확장 로제비앙 메가시티 - 커뮤니티</title>
        <meta
          name="description"
          content="신확장 로제비앙 메가시티의 커뮤니티 시설을 소개합니다. 피트니스 센터, 독서실, 카페 등 다양한 편의시설이 마련되어 있어 입주민의 생활 품격을 높이고, 편리함을 제공합니다."
        />
        <meta
          name="keywords"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "신확장 로제비앙 메가시티 - 커뮤니티",		"description": "신확장 로제비앙 메가시티의 커뮤니티 시설을 소개합니다. 피트니스 센터, 독서실, 카페 등 다양한 편의시설이 마련되어 있어 입주민의 생활 품격을 높이고, 편리함을 제공합니다.",		"url": "https://leecols.kr/ComplexGuide/community"	}	`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        신확장 로제비앙 메가시티의 커뮤니티 페이지에서는 단지 내 다양한 커뮤니티
      ...
      <img
				...
				src={page1}
				alt="신확장 로제비앙 메가시티 커뮤니티 안내 -image1"
